using System;
using System.Collections.Generic; // since I will be working with lists here; I need this
...
namespace ShapeTracker
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine("Enter 'R' to determine a type of rectangle, Enter 'E' for Ellipses and Enter 'T' for triangle");

            string startApp = Console.ReadLine().ToUpper();

            if (startApp == "T")
            {
                Console.WriteLine("You Enterred Triangle");
                ...
                static void ConfirmOrEditTriangle(Triangle tri)
                {
                    ...
                    Console.WriteLine($"Side 3 has the length of {tri.Side3}");
                    Console.WriteLine();
                ...
                // I wrote two other methods in my Triangle business logic file, Now I need a UI method to be able to access those business logic methods
                // them 2 methods are: ClearAll(), and GetAll()
            ...
            {
                Console.WriteLine("You Enterred Rectangle");


            }
            else if (startApp == "E")
            {
                Console.WriteLine("You Enterred Ellipse");
            }

            // Console.WriteLine

            // A method if user wants to work with Triangles
            // static void IfTriangle
            // {
